...
const TEAM_THEME: CanvasTheme = {
  sectionBackground:
    "linear-gradient(180deg, #00D2BE 0%, #006C63 50%, #071C1C 100%)",

  cinematicBar: "#EFFFFD",

  backgroundTitleColor: "rgba(245, 255, 255, 0.24)", // MERCEDES phía sau
  viewTitleColor: "rgba(245, 255, 255, 0.56)", // W11

  mainText: "#F5FFFF",
  line: "#F5FFFF",

  buttonActiveBg: "#F5FFFF",
  buttonActiveText: "#061B1B",
  buttonActiveBorder: "#F5FFFF",

  buttonIdleBg: "rgba(245, 255, 255, 0.08)",
  buttonIdleText: "#F5FFFF",
  buttonIdleBorder: "rgba(245, 255, 255, 0.35)",
};
