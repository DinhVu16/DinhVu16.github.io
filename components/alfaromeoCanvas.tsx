...
const TEAM_THEME: CanvasTheme = {
  sectionBackground:
    "linear-gradient(180deg, #900000 0%, #5A0000 50%, #130508 100%)",

  cinematicBar: "#FFF4F4",

  backgroundTitleColor: "rgba(255, 244, 244, 0.22)", // ALFA ROMEO phía sau
  viewTitleColor: "rgba(255, 244, 244, 0.56)", // C39
  ...
  buttonIdleBg: "rgba(255, 244, 244, 0.10)",
  buttonIdleText: "#FFF4F4",
  buttonIdleBorder: "rgba(255, 244, 244, 0.38)",
};
