...
========================================================= */
const TeamScene = dynamic(() => import("../../../components/alfaromeoCanvas"), {
  ssr: false,
});
...
const teamPageData: TeamPageData = {
  ...
  theme: {
    ...
    storyBefore: "rgba(255, 244, 244, 0.15)",
    storyAfter: "#FFF4F4",
  },
  ...
  primaryDriver: {
    name: "Kimi Räikkönen",
    videoUrl: "https://www.youtube.com/results?search_query=Kimi+Raikkonen+2020+Alfa+Romeo+highlights",
  ...
  items: [
    ["Constructors", "8th", ""],
    ["Total Points", "8", ""],
    ["Best Finish", "P9", "(Tuscan GP / Emilia-Romagna GP)"],
    ["Key Moment", "Kimi Record", "(323rd F1 start at Eifel GP)"],
  ],
},
};
