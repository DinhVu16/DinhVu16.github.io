...
========================================================= */
const TeamScene = dynamic(() => import("../../../components/alphatauriCanvas"), {
  ssr: false,
});
...
const teamPageData: TeamPageData = {
  ...
  theme: {
    ...
    storyBefore: "rgba(243, 247, 255, 0.15)",
    storyAfter: "#F3F7FF",
  },
  ...
  primaryDriver: {
    name: "Pierre Gasly",
    videoUrl: "https://www.youtube.com/results?search_query=Pierre+Gasly+Monza+2020+win",
